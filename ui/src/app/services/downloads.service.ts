...
export class DownloadsService {
  ...
  public add(url: string, quality: string, format: string, folder: string, customNamePrefix: string, playlistItemLimit: number, autoStart: boolean, splitByChapters: boolean, chapterTemplate: string, downloadThumbnail: boolean, downloadMetadata: boolean) {
    return this.http.post<Status>('add', { url: url, quality: quality, format: format, folder: folder, custom_name_prefix: customNamePrefix, playlist_item_limit: playlistItemLimit, auto_start: autoStart, split_by_chapters: splitByChapters, chapter_template: chapterTemplate, download_thumbnail: downloadThumbnail, download_metadata: downloadMetadata }).pipe(
  ...
  public addDownloadByUrl(url: string): Promise<{
    ...
    return new Promise((resolve, reject) => {
      this.add(url, defaultQuality, defaultFormat, defaultFolder, defaultCustomNamePrefix, defaultPlaylistItemLimit, defaultAutoStart, defaultSplitByChapters, defaultChapterTemplate, false, false)
        .subscribe({
